...
OUT:= game
SOURCE = Main.cpp GameWindow.cpp Buttom.cpp Bird.cpp Title.cpp Rect.cpp Boss.cpp Weapon.cpp
OBJ = Main.o GameWindow.o Buttom.o Bird.o Title.o Rect.o Boss.o Weapon.o
